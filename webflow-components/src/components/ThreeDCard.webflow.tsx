...
const My3DCardSlider = ({ title, text, buttonText, itemId }: any) => {
...
export default declareComponent(My3DCardSlider, {
    name: 'ThreeDCardSlider',
    description: '3D Card with infinite internal slider',
    group: 'Cards',
    props: {
        title: props.Text({ name: "Título", defaultValue: "Galería de Proyecto" }),
        text: props.Text({ name: "Texto", defaultValue: "Explora las imágenes de este item." }),
        itemId: props.Text({ name: "Item ID", defaultValue: "" }),
        buttonText: props.Text({ name: "Texto Botón", defaultValue: "Ver detalles" })
    }
});